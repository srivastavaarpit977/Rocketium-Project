...
```bash
   git clone https://github.com/srivastavaarpit977/Rocketium-Project.git
```
...
- *url* : `http://localhost:3000/api/data`
   ...
   * *output* ![Get all data](images/gettingAllData.png)

### Filter data
- *url* :  `http://localhost:3000/api/data?filter=language:Hindi` 

   * *output*![Filter data](images/filter.png)

### Sort data

- *url* : `http://localhost:3000/api/data?sort=version:desc`
  
    * *output* ![Sort data](images/sort.png)

### Filter and sort

- *url* : `http://localhost:3000/api/data?filter=language:Hindi&sort=id:desc`

    * *output* ![Filter and sort](images/filter&sort.png)
...
- *Invalid sort format*
  ...
  - *Response*: ![Invalid sort format]

- *No matching items*
  - *URL*: `http://localhost:3000/api/data?filter=language=hinfi`
  - *Response*: ![No matching items]

- *Invalid filter format*
  - *URL*: `http://localhost:3000/api/data?filter=language`
  - *Response*: ![Invalid filter format]

- *Unrecognized query parameters*
  - *URL*: `http://localhost:3000/api/data?sorted`
  - *Response*: ![Unrecognized query parameters]
